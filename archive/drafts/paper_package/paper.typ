...
+ *Extended the template to arbitrary lattice dimensions* (2-by-16, 2-by-18, 2-by-20, 2-by-22) by adding column pairs to both sides of the base template, maintaining a single contiguous scaffold loop at each step.
