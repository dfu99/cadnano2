...
2. **Add sequence assignment methods** — Enable scaffold sequence assignment through agent methods
3. **Generate irregular layouts** — L-shapes, T-shapes for more diverse training data
